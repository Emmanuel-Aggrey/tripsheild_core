...
DATABASE_HOST = config.get("DATABASE_HOSTT")
DATABASE_USER = config.get("DATABASE_USERT")
DATABASE_PASSWORD = config.get("DATABASE_PASSWORDT")
DATABASE_NAME = config.get("DATABASE_NAMET")
DATABASE_PORT = config.get("DATABASE_PORTT")
SENTRY_DSN = config.get("SENTRY_DSNTT")
...
ADMIN_LOGIN_USERNAME = config.get("ADMIN_LOGIN_USERNAME")
ADMIN_LOGIN_PASSWORD = config.get("ADMIN_LOGIN_PASSWORD")
